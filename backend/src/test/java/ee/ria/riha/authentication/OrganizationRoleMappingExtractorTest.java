...
public class OrganizationRoleMappingExtractorTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][] {
          ...
          {
            "123-456-789-kirjeldaja",
            createExpectedOrganizationRoleMapping("123-456-789", "ROLE_KIRJELDAJA")
          },
          ...
          {
            "this-is-valid-1234567890-.&!+-#$%^-nA_Me",
            createExpectedOrganizationRoleMapping(
  ...
  private OrganizationRoleMappingExtractor organizationRoleMappingExtractor =
      new OrganizationRoleMappingExtractor();
  public String commonNameInput;
  public OrganizationRoleMapping expectedOrganizationRoleMapping;

  private static OrganizationRoleMapping createExpectedOrganizationRoleMapping(
      String expectedCode, String expectedRole) {
  ...
  public void test(
      String commonNameInput, OrganizationRoleMapping expectedOrganizationRoleMapping) {
    ...
    OrganizationRoleMapping organizationRoleMapping =
        organizationRoleMappingExtractor.extract(commonNameInput, DISPLAY_NAME);
    assertThat(organizationRoleMapping, equalTo(expectedOrganizationRoleMapping));
  }

  public void initOrganizationRoleMappingExtractorTest(
      String commonNameInput, OrganizationRoleMapping expectedOrganizationRoleMapping) {
