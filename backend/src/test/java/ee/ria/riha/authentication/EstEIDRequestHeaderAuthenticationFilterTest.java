...
public class EstEIDRequestHeaderAuthenticationFilterTest {
  ...
  private static final String MARY_ANN_SUBJECT_DN =
      "SERIALNUMBER="
          + MARY_ANN_SERIAL_NUMBER
          + ",GN="
          + MARY_ANN_GIVEN_NAME
          + ",SN="
          + MARY_ANN_SURNAME;
  private static final String MARY_ANN_CERT =
      "MIIEmTCCA4GgAwIBAgIQAPVvrDwlATtUhxSc97Dd6zANBgkqhkiG9w0BAQsFADBs"
  ...
  @InjectMocks
  private EstEIDRequestHeaderAuthenticationFilter filter =
      new EstEIDRequestHeaderAuthenticationFilter();

  private MockHttpServletRequest createRequest(String subjectDn, String cert) {
    MockHttpServletRequestBuilder request =
        MockMvcRequestBuilders.request(HttpMethod.GET, "/login/esteid");
