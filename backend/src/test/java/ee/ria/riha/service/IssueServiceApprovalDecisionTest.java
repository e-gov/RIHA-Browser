...
public class IssueServiceApprovalDecisionTest {
  ...
  public void createsApprovalDecisionCommentAndEvent() {
    ...
    issueService.makeApprovalDecision(
        existingIssue,
        IssueApprovalDecisionModel.builder()
    ...
    assertThat(
        issueEvent.getOrganizationName(), is(Matchers.equalTo("Eesti Väikeloomaarstide Selts")));
  ...
  public void doesNotAddCommentWhenItWasNotProvided() {
    ...
    verify(issueCommentService, never())
        .createIssueCommentWithoutNotification(anyLong(), any(IssueCommentModel.class));
    verify(issueCommentService, never())
        .createIssueComment(anyLong(), any(IssueCommentModel.class));
  }
  ...
  public void throwsExceptionWhenDecisionWasNotProvided() {
    assertThrows(
        ...
        () -> {
          ...
          issueService.makeApprovalDecision(
              existingIssue,
              IssueApprovalDecisionModel.builder().comment("decision must be provided").build());
        });
  }
}
