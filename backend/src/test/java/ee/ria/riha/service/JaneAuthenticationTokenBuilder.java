...
/**
 * Builder for Jane Doe authentication token.
 *
 * <p>Jane is a user with first name <strong>Jane</strong> and last name <strong>Doe</strong>. Her
 * personal code is <strong>EE40102031234</strong>. Jane user name is <strong>jane.doe</strong> and
 * password is <strong>strong</strong>. Jane base authority is <strong>ROLE_RIHA_USER</strong>. Jane
 * is a member of organization with name <strong>Acme org</strong> and code
 * <strong>555010203</strong> where she poses authority <strong>ROLE_KIRJELDAJA</strong>.
 *
...
public class JaneAuthenticationTokenBuilder {
  ...
  private List<GrantedAuthority> baseAuthorities =
      AuthorityUtils.createAuthorityList(AUTHENTICATED_USER.getRole());

  private String personalCode = PERSONAL_CODE;

  public static ImmutableMultimap<RihaOrganization, GrantedAuthority> organizations =
  ...
  public JaneAuthenticationTokenBuilder setBaseAuthorities(List<GrantedAuthority> baseAuthorities) {
