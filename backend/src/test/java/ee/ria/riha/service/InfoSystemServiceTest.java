...
public class InfoSystemServiceTest {
  ...
  @Mock private JsonValidationService infoSystemValidationService;

  @InjectMocks private InfoSystemService infoSystemService;
  ...
  public void setUp() {
    SecurityContextHolder.getContext()
        .setAuthentication(
            TestUtils.getOAuth2LoginToken(null, JaneAuthenticationTokenBuilder.ORGANIZATION_CODE));
  ...
  public void setsNewUpdateTimestampDuringInfoSystemUpdate() {
    ...
    assertThat(
        infoSystem.getUpdateTimestamp(), is(not(equalTo(existingInfoSystem.getUpdateTimestamp()))));
  }
  ...
  public void doesNotChangeCreationTimestampDuringUpdate() {
    ...
    assertThat(
        infoSystem.getCreationTimestamp(), is(equalTo(existingInfoSystem.getCreationTimestamp())));
  }
}
