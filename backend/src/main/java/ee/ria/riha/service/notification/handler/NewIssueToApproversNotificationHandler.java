...
@Component
public class NewIssueToApproversNotificationHandler
    extends IssueNotificationHandler<NewIssueToApproversEmailNotification> {

  private static final String STANDARD_SUBJECT_KEY = "notifications.newIssue.toApprovers.subject";
  private static final String ESTABLISHMENT_REQUEST_SUBJECT_KEY =
      "notifications.newApprovalRequestIssue.establishmentRequest.subject";
  private static final String TAKE_INTO_USE_REQUEST_SUBJECT_KEY =
      "notifications.newApprovalRequestIssue.takeIntoUseRequest.subject";
  private static final String MODIFICATION_REQUEST_SUBJECT_KEY =
      "notifications.newApprovalRequestIssue.modificationRequest.subject";
  private static final String FINALIZATION_REQUEST_SUBJECT_KEY =
      "notifications.newApprovalRequestIssue.finalizationRequest.subject";
  ...
  protected Map<String, Object> createTemplateModel(
      NewIssueToApproversEmailNotification notification) {
