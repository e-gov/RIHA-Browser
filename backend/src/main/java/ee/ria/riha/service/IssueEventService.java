...
public class IssueEventService {
  ...
  public static final Function<Comment, IssueEvent> COMMENT_TO_ISSUE_EVENT =
      comment -> {
        if (comment == null) {
          return null;
        }
  ...
  public static final Function<IssueEvent, Comment> ISSUE_EVENT_TO_COMMENT =
      issueEvent -> {
        if (issueEvent == null) {
          return null;
        }
  ...
  public static final Function<Comment, IssueEventSummaryModel>
      COMMENT_TO_ISSUE_EVENT_SUMMARY_MODEL =
          comment -> {
            if (comment == null) {
              return null;
            }
  ...
  public void createEvent(Long issueId, IssueEvent issueEvent) {
    ...
    List<Long> createdIssueEventIds =
        commentRepository.add(ISSUE_EVENT_TO_COMMENT.apply(issueEvent));
