...
/**
 * Base class for exceptions that contain error code and arguments. These exceptions, when presented
 * to the caller, allow custom handling according to the code, type and arguments.
 *
