...
public class InfoSystemAuthorizationService {
  ...
  /**
   * Checks if current user belongs to organization that is owner of the info system referenced by
   * either UUID or short name. Returns true if and only if current user active organization code is
   * same as info system owner.code.
   *
   * @param reference info system reference
   * @return true when current user active organization code is same as info system owner code,
   *     false otherwise
   */
  ...
  /**
   * Checks if current user belongs to organization that is owner of this particular info system.
   * Returns true if and only if current user active organization code is same as info system
   * owner.code.
   *
