...
@Component
public class NewIssueToSystemContactsNotificationHandler
    extends IssueNotificationHandler<NewIssueToSystemContactsEmailNotification> {
  ...
  protected Map<String, Object> createTemplateModel(
      NewIssueToSystemContactsEmailNotification notification) {
