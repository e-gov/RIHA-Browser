...
public class IssueCommentService {
  ...
  public static final Function<Comment, IssueComment> COMMENT_TO_ISSUE_COMMENT =
      comment -> {
        if (comment == null) {
          return null;
        }
  ...
  public static final Function<IssueComment, Comment> ISSUE_COMMENT_TO_COMMENT =
      issueComment -> {
  ...
  public static final Function<Comment, DashboardIssueComment> COMMENT_TO_DASHBOARD_ISSUE_COMMENT =
      comment -> {
        if (comment == null) {
          return null;
        }
   ...
   */
  public PagedResponse<IssueComment> listIssueComments(
      Long issueId, Pageable pageable, Filterable filterable) {
    Filterable filter =
    ...
    return new PagedResponse<>(
        ...
        response.getContent().stream().map(COMMENT_TO_ISSUE_COMMENT).collect(toList()));
  }
  ...
  public IssueComment createIssueCommentWithoutNotification(Long issueId, IssueCommentModel model) {
    ...
    List<Long> createdIssueCommentIds =
        commentRepository.add(ISSUE_COMMENT_TO_COMMENT.apply(issueComment));
