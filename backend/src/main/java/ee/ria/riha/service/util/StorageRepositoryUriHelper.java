...
public class StorageRepositoryUriHelper {
  ...
  public static UriComponentsBuilder createRequestForPathAndOperation(
      String baseUrl, String path, OperationType operation) {
  ...
  public static void setFilter(
      UriComponentsBuilder uriBuilder, Pageable pageable, Filterable filterable) {
    if (pageable != null) {
  ...
  public static void setCompositeFilter(
      UriComponentsBuilder uriBuilder, Pageable pageable, CompositeFilterRequest filterRequest) {
    if (pageable != null) {
