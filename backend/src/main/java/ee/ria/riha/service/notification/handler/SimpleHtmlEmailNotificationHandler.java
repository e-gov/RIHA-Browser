...
@Slf4j
public abstract class SimpleHtmlEmailNotificationHandler<T extends SimpleHtmlEmailNotification>
    implements EmailNotificationHandler<T> {
  ...
  /**
   * Populates message with CC addresses. CC addresses are optional and will not be set if model
  ...
  /**
   * Populates message with BCC addresses. BCC addresses are optional and will not be set if model
   * does not contain them.
   *
   * @param helper message helper
   * @param model message data model
