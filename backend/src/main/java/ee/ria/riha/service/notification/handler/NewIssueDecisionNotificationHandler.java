...
@Component
public class NewIssueDecisionNotificationHandler
    extends IssueNotificationHandler<NewIssueDecisionEmailNotification> {

  private static final Map<IssueResolutionType, String> DECISION_MESSAGE_CODES =
      Maps.newEnumMap(
          ImmutableMap.of(
  ...
  protected Map<String, Object> createTemplateModel(
      NewIssueDecisionEmailNotification notification) {
