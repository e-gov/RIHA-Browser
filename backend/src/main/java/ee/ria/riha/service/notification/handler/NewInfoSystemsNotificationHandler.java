...
@Component
public class NewInfoSystemsNotificationHandler
    extends IssueNotificationHandler<NewInfoSystemsEmailNotification> {
  ...
  protected HashMap<String, Object> createTemplateModel(
      NewInfoSystemsEmailNotification notification) {
