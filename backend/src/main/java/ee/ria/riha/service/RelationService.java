...
public class RelationService {
  ...
  private static final Function<MainResourceRelation, Relation> MAIN_RESOURCE_RELATION_TO_RELATION =
      mainResourceRelation -> {
        ...
        return Relation.builder()
            ...
            .type(
                mainResourceRelation.getType() != null
  ...
  private static final BiFunction<MainResourceRelation, Boolean, RelationResponse>
      RELATION_RESPONSE =
          (mainResourceRelation, relationType) -> {
            if (mainResourceRelation == null) {
              return null;
            }
            ...
            return RelationResponse.builder()
                ...
                .infoSystemStatus(
                    relationType
                        ? mainResourceRelation.getInfosystem_status()
                        : mainResourceRelation.getRelated_infosystem_status())
                .relatedInfoSystemUuid(mainResourceRelation.getRelated_infosystem_uuid())
                .relatedInfoSystemName(mainResourceRelation.getRelated_infosystem_name())
                .relatedInfoSystemShortName(mainResourceRelation.getRelated_infosystem_short_name())
                .type(
  ...
  private static final Function<Relation, MainResourceRelation> RELATION_TO_MAIN_RESOURCE_RELATION =
      relation -> {
        if (relation == null) {
          return null;
        }
        ...
        mainResourceRelation.setRelated_infosystem_short_name(
            relation.getRelatedInfoSystemShortName());
  ...
  /**
   * Lists {@link Relation}s for info system referenced by either UUID or short name. List consists
   * of two types of {@link Relation}s:
   *
   * <ul>
   *   <li>In direct relation, info system with given reference is related <strong>to</strong>
   *       another info system.
   *   <li>In reverse relation, info system with given reference is related <strong>by</strong>
   *       another system. Such {@link Relation} is marked as reversed.
   * </ul>
   *
  ...
  public List<RelationResponse> listRelations(String reference) {
    ...
    List<RelationResponse> allRelations =
  ...
  /**
   * Creates {@link Relation} from info system referenced by either UUID or short name to another
   * info system with given type.
   *
  ...
  public Relation createRelation(String reference, RelationModel relatedModel) {
    ...
    List<Long> createRelationIds =
        mainResourceRelationRepository.add(
    ...
    Relation createdRelation =
        MAIN_RESOURCE_RELATION_TO_RELATION.apply(
  ...
  /**
   * Normalizes {@link Relation} by choosing minimal ordinal value of {@link RelationType} or its
   * opposite type. In case opposite value has lower ordinal value, {@link Relation} is reversed.
   *
  ...
  /**
   * Deletes single {@link Relation} if info system referenced by either UUID or short name is part
   * of this relation.
   *
   * @param reference info system reference
