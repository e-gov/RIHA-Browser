 ...
 */
@Component
public class IssueStatusUpdateNotificationHandler
    extends IssueNotificationHandler<IssueStatusUpdateNotification> {
  ...
  protected HashMap<String, Object> createTemplateModel(
      IssueStatusUpdateNotification notification) {
