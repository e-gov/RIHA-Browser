...
public class CompositeFilterArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  public Object resolveArgument(
    ...
    List<String> filterParameters =
        filterParametersFromRequest != null ? Arrays.asList(filterParametersFromRequest) : null;
    List<String> sortParameters =
        sortParametersFromRequest != null ? Arrays.asList(sortParametersFromRequest) : null;
