...
public class AuditLogger {
  ...
  /** Auditlog. data objects will be serialized to JSON. */
  public void log(
      AuditEvent auditEvent, AuditType auditType, HttpServletRequest request, Object... data) {
    ...
    sb.append(" %s:%s:%s; ".formatted(getClientIpAddress(request), auditEvent, auditType));
    sb.append(" %s:%s:%s; ".formatted(userId, userName, organization));
    try {
