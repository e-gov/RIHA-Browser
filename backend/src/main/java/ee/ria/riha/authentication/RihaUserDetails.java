...
public class RihaUserDetails implements UserDetails, OidcUser, Serializable {
  ...
  private void initOrganizationAuthorities(
      Multimap<RihaOrganization, GrantedAuthority> organizationAuthorities) {
    this.organizationAuthorities =
        organizationAuthorities != null
  ...
  public OidcIdToken getIdToken() {
    return userRequest != null ? userRequest.getIdToken() : null;
  }
  ...
  public void setActiveOrganization(String organisationCode) {
    if (organisationCode != null
        && this.getOrganizationsByCode() != null
        && getOrganizationsByCode().containsKey(organisationCode)) {
