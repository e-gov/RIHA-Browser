...
public class UserController {
  ...
  public ResponseEntity<UserDetailsModel> changeActiveOrganization(
      @RequestBody(required = false) String organizationCode) {
  ...
  private void setAuthorityDetails(UserDetailsModel model) {
    ...
    if (rihaUserDetails.getOrganizationAuthorities() != null) {
      rihaUserDetails
          ...
          .keySet()
          .forEach(
              organization -> model.getOrganizations().add(createOrganizationModel(organization)));
    }
  }
