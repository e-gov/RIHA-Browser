...
public class ApplicationProperties {
  ...
  private final LdapAuthenticationProperties ldapAuthentication =
      new LdapAuthenticationProperties();
  ...
  @Setter private String nationalHolidaysFile;
  ...
  public static class NotificationProperties {
    private final CreatedInfoSystemsOverview createdInfoSystemsOverview =
        new CreatedInfoSystemsOverview();
