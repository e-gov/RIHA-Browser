...
public class StorageConfiguration {
  ...
  @Bean
  public MainResourceRelationRepository mainResourceRelationRepository(
  ...
  @Bean
  public LdapRepository ldapRepository(
      LdapContextSource ldapContextSource, ApplicationProperties applicationProperties) {
