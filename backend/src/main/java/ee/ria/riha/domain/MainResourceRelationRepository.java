...
/**
 * Makes calls against RIHA-Storage and performs various operations on {@link MainResourceRelation}
 * entities.
 *
 * @author Valentin Suhnjov
 */
public class MainResourceRelationRepository
    implements StorageRepository<Long, MainResourceRelation> {
  ...
  public PagedResponse<MainResourceRelation> list(Pageable pageable, Filterable filterable) {
    return storageClient.list(
        MAIN_RESOURCE_RELATION_VIEW_PATH, pageable, filterable, MainResourceRelation.class);
  }
  ...
  public List<MainResourceRelation> find(Filterable filterable) {
    return storageClient.find(
        MAIN_RESOURCE_RELATION_VIEW_PATH, filterable, MainResourceRelation.class);
  }
