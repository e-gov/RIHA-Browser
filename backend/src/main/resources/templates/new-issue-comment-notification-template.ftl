...
<body>
    <p>Infosüsteemi <a href="${baseUrl}/Infosüsteemid/Vaata/${shortName}">${name}</a> arutelusse "<a href="${baseUrl}/Infosüsteemid/Vaata/${shortName}/Arutelu/${issueId?c}">${issueTitle}</a>" on lisatud uus kommentaar:</p>
