...
<body>
    <p>Infosüsteemi <a href="${baseUrl}/Infosüsteemid/Vaata/${infoSystem.uuid}">${name}</a> arutelusse "<a href="${baseUrl}/Infosüsteemid/Vaata/${infoSystem.uuid}/Arutelu/${issueId?c}">${issueTitle}</a>" on lisatud uus kommentaar:</p>
