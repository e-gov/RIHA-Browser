    ...
    var conf = [
        ...
        it('fills table rows correctly', function () {
           loadFixtures('detailTable.html');
            ...
            expect($(rows[7]).find('.fieldvalue').text()).toBe(data.uses_standard_solution);
            ...
            expect($(rows[9]).find('.fieldvalue').text()).toBe("Kõrge");
            expect($(rows[10]).find('.fieldname').text()).toBe(conf[10].displayName);
            expect($(rows[10]).find('.fieldvalue').text()).toBe("");
            ...
            expect($(rows[12]).find('.fieldvalue').text()).toBe(data.status_of_applying_iske);
            expect($(rows[13]).find('.fieldname').text()).toBe(conf[13].displayName);
            expect($(rows[13]).find('.fieldvalue').text()).toBe("");
