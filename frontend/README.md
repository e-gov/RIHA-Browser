...
It will install node, yarn, other node packages into `frontend` directory in order to build frontend module. Additionally it will run lint to check code style and run tests using Chrome headless browser with karma.
